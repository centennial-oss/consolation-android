 ...
 * the patch in libusb-1.0.29-prealloc.patch.  It is intentionally NOT a standalone
 ...
 *   patch -p1 -d libusb-X.Y.Z < patches/libusb-1.0.29-prealloc/libusb-1.0.29-prealloc.patch
 *   cp patches/libusb-1.0.29-prealloc/libusb_prealloc_ext.c libusb-X.Y.Z/libusb/os/
 *   cp patches/libusb-1.0.29-prealloc/libusb_prealloc.h     libusb-X.Y.Z/libusb/
 */
